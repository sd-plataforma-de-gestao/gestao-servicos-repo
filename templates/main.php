      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="actions-grid">
            ...
            <button class="action-btn" onclick="window.location.href='/portal-repo-og/templates/unidade.php'">
              <i class="fas fa-calendar-check"></i>
              <span class="action-title">Visualizar unidade</span>
              <small class="action-subtitle">Verificar informações da unidade</small>
            </button>
